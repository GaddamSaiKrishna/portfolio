  ...
  <div style={{ width: '100%', margin: '0 auto', maxWidth: 1100 }}>
    ...
    <motion.section id="education" custom={0} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={sectionVariant} className="fade-up">
      <h2 style={{display: 'flex', alignItems: 'center', justifyContent:'center', gap: 16}}>
        <img src={nitLogo} alt="NIT Durgapur Logo" style={{height: 48, width: 48, borderRadius: 8, background: '#fff', boxShadow: '0 2px 8px rgba(0,0,0,0.07)'}} />
        Education
      </h2>
    ...
    <motion.section id="projects" custom={1} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={sectionVariant} className="fade-up">
      ...
      <div className="projects-grid">
        <div className="project-card fade-up">
          <img src={project1} alt="CIT 8.0 Quiz Website" className="project-img" />
        ...
        <div className="project-card fade-up">
          <img src={project2} alt="MESA Official Website" className="project-img" />
          <div className="project-content">
    ...
    <motion.section id="positions" custom={2} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={sectionVariant} className="fade-up">
      ...
      <div className="positions-timeline">
        <div className="timeline-item">
          <div className="timeline-logo"><img src={isteLogo} alt="ISTE Logo" /></div>
          <div className="timeline-line"></div>
          <div className="timeline-content fade-up">
            <b>Treasurer & Web Developer | ISTE Students’ Chapter NIT Durgapur</b> (Mar 2024 - present)<br/>
        ...
        <div className="timeline-item">
          <div className="timeline-logo"><img src={mesaLogo} alt="MESA Logo" /></div>
          <div className="timeline-line"></div>
          <div className="timeline-content fade-up">
            <b>Convener & Graphic Designer | Mechanical Engineering Students’ Association, NIT Durgapur</b> (Oct 2023 - present)<br/>
        ...
        <div className="timeline-item">
          <div className="timeline-logo"><img src={nssLogo} alt="NSS Logo" /></div>
          <div className="timeline-line"></div>
          <div className="timeline-content fade-up">
            <b>Unit Leader & Volunteer | National Service Scheme, NIT Durgapur</b> (Mar 2023 - present)<br/>
